...
def main(stdscr):
    ...
    main_window.equal_cond("buy", True, main_window.add_item, conditem)
    main_window.equal_cond("buy", False, main_window.remove_item, conditem.symbol)
    conditem1 = BoolItem(symbol="kobbbb", default=False, help_str="xxxx")
